...
export const ResultsDisplay = ({ result, onReset }: ResultsDisplayProps) => {
  ...
  // Extract the "STRATEGIC ANALYSIS COMPLETE" part and the rest
  ...
  useEffect(() => {
    ...
    // Start by showing the Soviet terminal
    setShowSovietTerminal(true);
  }, [isRejected]);

  const handleSovietTerminalComplete = () => {
  ...
  return (
    <div ref={containerRef} className="flex-1 flex items-start justify-center pt-16">
      <div className="w-full max-w-6xl px-8">
        ...
        {/* Soviet Terminal for Strategic Analysis Complete */}
        {showSovietTerminal && strategicAnalysisMatch && (
          <SovietTerminal 
            text={strategicAnalysisText}
            speed={50}
            onComplete={handleSovietTerminalComplete}
          />
        )}
