      ...
      <div className="w-full max-w-6xl px-4 sm:px-8 mx-auto flex flex-col justify-center items-center min-h-screen">
        ...
        <div className="text-center">
          <div ref={promptRef} className="mb-12">
            <div className="text-container relative text-center mb-4">
              {/* Russian text to be struck through */}
              <p className="russian-text text-mono-prompt text-document-aged">
                <span className="strikethrough"></span>
                ОПИШИТЕ ВАШУ ЦЕЛЬ:
              </p>
              
              {/* Faux Cyrillic replacement text */}
              <p className="faux-cyrillic-text text-mono-prompt text-blood-accent">
